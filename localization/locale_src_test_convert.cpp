...
void test_normc(std::basic_string<Char> orig,std::basic_string<Char> normal,cppcms::locale::norm_type type)
{
...
void test_norm(std::string orig,std::string normal,cppcms::locale::norm_type type)
{
