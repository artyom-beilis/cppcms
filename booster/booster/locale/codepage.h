...
//
#ifndef BOOSTER_LOCALE_CODEPAGE_H_INCLUDED
#define BOOSTER_LOCALE_CODEPAGE_H_INCLUDED
...
namespace booster {
    namespace locale {
        ...
        /// \cond INTERNAL 
        template<>
        BOOSTER_API std::codecvt<char,char,mbstate_t> *create_codecvt(info const &inf);

        #ifndef BOOSTER_NO_STD_WSTRING
        template<>
        BOOSTER_API std::codecvt<wchar_t,char,mbstate_t> *create_codecvt(info const &inf);
        #endif

        #ifdef BOOSTER_HAS_CHAR16_T
        template<>
        BOOSTER_API std::codecvt<char16_t,char,mbstate_t> *create_codecvt(info const &inf);
        #endif

        #ifdef BOOSTER_HAS_CHAR32_T
        template<>
        BOOSTER_API std::codecvt<char32_t,char,mbstate_t> *create_codecvt(info const &inf);
        #endif
        /// \endcond
