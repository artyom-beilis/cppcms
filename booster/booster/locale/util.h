...
namespace util {
    ...
    /// unicode code points
    ///
    BOOSTER_API std::unique_ptr<base_converter> create_utf8_converter_unique_ptr();
    ///
    /// This function creates a \a base_converter that can be used for conversion between single byte
    /// character encodings like ISO-8859-1, koi8-r, windows-1255 and Unicode code points,
    /// 
    ...
    ///
    BOOSTER_API std::unique_ptr<base_converter> create_simple_converter_unique_ptr(std::string const &encoding);
    ...
    /// unicode code points
    ///
    BOOSTER_API base_converter *create_utf8_converter_new_ptr();
    ///
    /// This function creates a \a base_converter that can be used for conversion between single byte
    /// character encodings like ISO-8859-1, koi8-r, windows-1255 and Unicode code points,
    /// 
    ...
    /// std::unique_ptr<base_converter>::get() != 0
    ///
    BOOSTER_API base_converter *create_simple_converter_new_ptr(std::string const &encoding);
