...
public:
    ...
    num_format(booster::shared_ptr<locale_t> lc,size_t refs = 0) : 
...
public:
    time_put_posix(booster::shared_ptr<locale_t> lc, size_t refs = 0) : 
...
public:
    ...
    ctype_posix(booster::shared_ptr<locale_t> lc) 
    {
        lc_ = lc;
    }
