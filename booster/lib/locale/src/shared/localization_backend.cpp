...
namespace booster {
    namespace locale {
        ...
        public:
            ...
            {
                booster::shared_ptr<localization_backend> sptr(backend_ptr.release());
        ...
        private:
            ...
            private:
                std::vector<booster::shared_ptr<localization_backend> > backends_;
                std::vector<int> index_;
            };

            typedef std::vector<std::pair<std::string,booster::shared_ptr<localization_backend> > > all_backends_type;
        ...
        namespace {
            ...
            booster::mutex &localization_backend_manager_mutex()
            {
                static booster::mutex the_mutex;
                return the_mutex;
            }
            // prevent initialization order fiasco
