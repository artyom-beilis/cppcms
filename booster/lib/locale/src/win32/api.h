...
//
#ifndef BOOSTER_LOCALE_IMPL_WIN32_API_HPP
#define BOOSTER_LOCALE_IMPL_WIN32_API_HPP
...
#define BOOSTER_LOCALE_WINDOWS_2000_API

#if defined(_WIN32_NT) && _WIN32_NT >= 0x600 && !defined(BOOSTER_LOCALE_WINDOWS_2000_API)
#define BOOSTER_LOCALE_WINDOWS_VISTA_API
#else
#define BOOSTER_LOCALE_WINDOWS_2000_API
#endif
...
namespace impl_win {
    ...
    #ifdef BOOSTER_LOCALE_WINDOWS_2000_API 
